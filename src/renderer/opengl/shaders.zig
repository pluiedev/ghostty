...
const pipeline_descs: []const struct { [:0]const u8, PipelineDescription } =
    &.{
        .{ "bg_color", .{
            .vertex_fn = loadShaderCode(shader_data.code.glsl.full_screen_vertex),
            .fragment_fn = loadShaderCode(shader_data.code.glsl.bg_color_fragment),
            .blending_enabled = false,
        } },
        .{ "cell_bg", .{
            .vertex_fn = loadShaderCode(shader_data.code.glsl.full_screen_vertex),
            .fragment_fn = loadShaderCode(shader_data.code.glsl.cell_bg_fragment),
            .blending_enabled = true,
        } },
        .{ "cell_text", .{
            .vertex_attributes = CellText,
            .vertex_fn = loadShaderCode(shader_data.code.glsl.cell_text_vertex),
            .fragment_fn = loadShaderCode(shader_data.code.glsl.cell_text_fragment),
            .step_fn = .per_instance,
            .blending_enabled = true,
        } },
        .{ "image", .{
            .vertex_attributes = Image,
            .vertex_fn = loadShaderCode(shader_data.code.glsl.image_vertex),
            .fragment_fn = loadShaderCode(shader_data.code.glsl.image_fragment),
            .step_fn = .per_instance,
            .blending_enabled = true,
        } },
        .{ "bg_image", .{
            .vertex_attributes = BgImage,
            .vertex_fn = loadShaderCode(shader_data.code.glsl.bg_image_vertex),
            .fragment_fn = loadShaderCode(shader_data.code.glsl.bg_image_fragment),
            .step_fn = .per_instance,
            .blending_enabled = true,
        } },
    };
...
fn loadShaderCode(comptime old: []const u8) [:0]const u8 {
